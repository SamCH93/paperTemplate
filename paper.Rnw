...
\title{\vspace{-2em}\textbf{Lorem ipsum dolor sit amet}}
\author{\textbf{Author names} \\
Affilitation, Country \\
E-mail: \href{mailto:email@email.com}{email@email.com}}
...
%% ----------------------------------------------------------------------------
%% Shortforms
\newcommand{\eg}{\latin{e.\,g.}} % e.g.
\newcommand{\ie}{\latin{i.\,e.}} % i.e.
\newcommand{\cf}{\latin{cf}} % cf
%% Distributions
